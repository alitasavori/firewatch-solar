      ...
      >
        ...
        {infoOpen && (
          <div className="map-info-panel">
            ...
            <p>
              An interactive map for exploring how wildfire smoke may affect solar power plants.
              It estimates baseline vs smoke-affected generation, a soiling risk score (SRI),
              and a simple bill impact.
            </p>
            <h4>Scope</h4>
            <p className="muted">
